...
export default class Soin extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: []
    ...
    componentDidMount() {
        //get request
        axios.get("http://localhost/php%20projects/homemade/Soin.php").then(res => {
    ...
    render() {
        ...
        return (
            <div class="container">
                <h2 className="h2About">All Cosmetic Products</h2>
